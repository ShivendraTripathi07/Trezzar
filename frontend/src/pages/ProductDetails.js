      ...
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        <div className="h-96 flex flex-col lg:flex-row-reverse gap-4">
          <div className="h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2">
            ...
            {/**product zoom */}
            {zoomImage && (
              <div className="z-10 hidden lg:block absolute min-w-[600px] overflow-hidden min-h-[550px] bg-slate-200 p-1 -right-[620px] top-0">
                <div
                  className="w-full h-full min-h-[550px] min-w-[600px] mix-blend-multiply"
                  style={{
                    backgroundImage: `url(${activeImage})`,
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: `${zoomImageCoordinate.x}% ${zoomImageCoordinate.y}%`,
                    backgroundSize: "200%", // Increase the size of the zoomed image
                  }}
                ></div>
              </div>
            )}
